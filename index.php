...
$app->add('GET', '/tarefas/editar', 'TaskController@editar');
$app->add('POST', '/tarefas/atualizar', 'TaskController@atualizar');
$app->add('GET', '/tarefas/deletar', 'TaskController@deletar');
